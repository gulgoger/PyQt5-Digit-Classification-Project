...
import matplotlib.image as mpig #load image
...
for i in range(2):
    ...
    print("Model {} Test Accuracy: {}".format(i+1, score[i]))
...
class Window(QMainWindow):
    ...
    def widgets(self):
        ...
        self.outputImage.setPixmap(QPixmap("icon1.jpg"))
    ...
    def predictionFunction(self):
        ...
        #load image as numpy
        img_array = cv2.imread("input_img.png")[26:175,26:175,0]
